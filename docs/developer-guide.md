...
6. [Testing and Operations](developer/testing-and-operations.md)
7. [Code Ownership Map](developer/code-ownership.md)
...
history, and export all work without a network. Telemetry is optional and must
never block the local speedometer.
