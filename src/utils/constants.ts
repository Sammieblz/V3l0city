...
export const LOCATION_STALE_TIMEOUT_MS = 3000;
export const RESPONSIVE_SPEED_DELTA_MPS = 1.2;
export const GPS_NATIVE_SPEED_BLEND = 0.7;
export const GPS_DERIVED_SPEED_BLEND = 0.35;
